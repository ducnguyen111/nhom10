...
import com.example.chitieucanhan.Adapter.QuanLyAdapter;
...
public class QuanLyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter themthuchiadapter=new ArrayAdapter(QuanLyActivity.this,android.R.layout.simple_list_item_1,themthuchi);
        ...
        llist=db.getALLS("");
        QuanLyAdapter arrayAdapter1=new QuanLyAdapter(getParent(),R.layout.custom_tong,llist);
                ...
                if (editText.getText().toString().length() > 0) {
                    ...
                    if (db.kiemtra(spinthuchi, editText.getText().toString()) == true) {
                        ...
                        View mToastView = inflater.inflate(R.layout.them_thanhcong,
                                null);
                        mToast = new Toast(QuanLyActivity.this);
    ...
    public void xoa(final int location, final String thuchi) {
        new AlertDialog.Builder(QuanLyActivity.this)
                .setTitle("Chú ý?")
